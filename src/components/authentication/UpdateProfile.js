...
export default function UpdateProfile() {
    ...
    const { currentUser, updatePasswordApp, updateEmailApp } = useAuth()
    ...
    function handleSubmit(e) {
        ...
        if(emailRef.current.value !== currentUser.email){
            promises.push(updateEmailApp(emailRef.current.value))
        }

        if(passwordRef.current.value){
            promises.push(updatePasswordApp(passwordRef.current.value))
        }
